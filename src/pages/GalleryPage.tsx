...
function GalleryLightbox({ img, visible, isAdding, getLoc, locale, onClose, onNavigate, onAddToCart }: GalleryLightboxProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`md:w-[48%] h-[52vh] md:h-full flex-none flex items-stretch ml-10 md:ml-24 cursor-zoom-out transition-opacity duration-500 ${visible ? 'opacity-100' : 'opacity-0'}`}
        onClick={onClose}
      >
        <img
