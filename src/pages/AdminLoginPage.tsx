...
export const AdminLoginPage: React.FC<AdminLoginPageProps> = ({ onLoginSuccess, t, locale }) => {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-sm font-bold uppercase tracking-widest text-neutral-400">Admin Login</p>
          </div>
