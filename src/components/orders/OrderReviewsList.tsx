...
interface OrderReviewsListProps {
  reviews: OrderReview[];
  currentUserId?: string;
  onReviewUpdate?: () => void;
  onEdit?: (review: OrderReview) => void;
}

export const OrderReviewsList: React.FC<OrderReviewsListProps> = ({
  reviews,
  currentUserId,
  onReviewUpdate,
  onEdit
  ...
  const handleHelpful = async (reviewId: string) => {
    ...
    try {
      const result = await api.toggleHelpful(reviewId);
