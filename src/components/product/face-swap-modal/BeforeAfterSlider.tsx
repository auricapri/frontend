...
export const BeforeAfterSlider: React.FC<BeforeAfterSliderProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Slider Line */}
      <div
        className="absolute left-0 right-0 h-1 bg-paper shadow-lg cursor-ns-resize"
      ...
      >
        {/* Handle */}
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-paper rounded-full shadow-lg flex items-center justify-center">
      ...
      {/* Labels */}
      <div className="absolute top-3 left-3 px-2 py-1 bg-paper/90 backdrop-blur-sm rounded-full text-[10px] font-bold uppercase tracking-wider">
        Depois
      </div>
