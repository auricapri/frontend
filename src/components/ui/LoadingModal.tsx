    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div className="relative flex flex-col items-center justify-center p-8">
        ...
        <div className="mt-4 flex gap-1.5">
          <span className="w-2 h-2 bg-paper/60 rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
          <span className="w-2 h-2 bg-paper/60 rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
          <span className="w-2 h-2 bg-paper/60 rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
        </div>
      </div>
    </div>
  );
