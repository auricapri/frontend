...
import { ArrowLeft, Download, ShoppingBag, MapPin, Calendar, Clock, DollarSign, Share2, MessageCircle, Check } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white md:bg-neutral-100 flex flex-col items-center justify-center relative animate-in fade-in duration-700">
      ...
      <div className="hidden md:flex absolute top-12 right-12 z-50 no-print gap-4">
         ...
         <button onClick={handlePrint} className="flex items-center gap-3 bg-black text-white px-6 py-3 rounded-full text-[10px] font-black uppercase tracking-widest shadow-xl hover:scale-105 transition-all">
      ...
      <div className="fixed bottom-0 left-0 w-full p-4 bg-white border-t border-neutral-100 md:hidden flex gap-3 z-50 no-print pb-8">
          <button 
            onClick={handlePrint}
            className="flex-1 py-4 border border-neutral-200 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 active:bg-neutral-50"
          >
