...
export type PaymentGatewayProvider = 'stripe' | 'pagarme' | 'mercadopago' | 'asaas' | 'cielo' | 'rede' | 'other';
...
export declare const DEFAULT_FINANCIAL_SETTINGS: GlobalFinancialSettings;
