...
export const useStoreData = () => {
  ...
  const fetchStoreData = useCallback(async () => {
    ...
    try {
      // Tenta usar o endpoint de bootstrap (1 chamada em vez de 9)
      ...
      if (configData) {
        ...
        if (Platform.OS === 'web' && typeof document !== 'undefined') {
          document.title = configData.brand_name || 'Auricapri';
        }
      }
      ...
      // Fallback: se bootstrap falhar, faz chamadas individuais
      try {
